...
ColumnDescriptionREGIONProvince nameYEARYear of the minimum wage recordSALARY (IDR)Minimum wage in Indonesian Rupiah
...
How has Indonesia's national average minimum wage trended over 28 years?
Which provinces have the highest and lowest minimum wages in 2025?
Which provinces experienced the fastest wage growth between 2015 and 2025?
How has the wage gap between the highest and lowest-paid provinces changed over time?
...
2023 data errors — All 35 provincial values had extra digits (e.g., 340,417,724 → 3,404,177). Fixed by dividing values by 10 or 100 depending on magnitude.
2024 INDONESIA row — National average was incorrectly entered with extra digits. Corrected by dividing by 100.
2017 Kalimantan Timur — Value was 339,556 (missing leading digit). Corrected to 2,339,556 based on surrounding years' trend.
